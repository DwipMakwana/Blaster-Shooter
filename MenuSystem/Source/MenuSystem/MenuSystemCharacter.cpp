...
void AMenuSystemCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccesfull)
{
	if (bWasSuccesfull)
	{
		GEngine->AddOnScreenDebugMessage(
...
void AMenuSystemCharacter::OnFindSessionsComplete(bool bWasSuccessfull)
{
