...
//
//	Declaring our own custom delegates for teh Menu class to bind callbacks to
//
...
public:
	...
	//
	//	To handle session funationality. The menu class will these.
	//
...
private:
	...
	//
	//	To add to to the Online Session Interface Delegate list.
